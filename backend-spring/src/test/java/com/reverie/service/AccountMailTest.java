...
class AccountMailTest {
    ...
    @BeforeEach
    void setUp() {
        mail = new AccountMail(outbox, users, meetings, "https://reverie.test", 900);
        user = new UserEntity();
        user.setId(USER);
    ...
    class Warning {
        ...
        void namesTheDay() {
            ...
            assertThat(q.text())
                    ...
                    .contains("https://reverie.test/settings#data");
        }
    ...
    class Reminder {
        ...
        void linked() {
            ...
            assertThat(queued().text()).contains("https://reverie.test/meetings/mtg_1");
        }
     ...
     * places in Reverie where personal data survives erasure, so what goes into
    ...
    class Payload {
        ...
        void noExcerpt() {
            ...
            Queued q = queued();
            assertThat(q.subject()).contains("Quarterly review");
            assertThat(q.text()).contains("https://reverie.test/meetings/mtg_9");
