...
class OutboxPublisherTest {
    ...
    void marksAfterTheAcknowledgement() {
        ...
        assertThat(counter("recallix.outbox.published")).isEqualTo(1d);
    }
    ...
    class Infrastructure {
        ...
        void recordsRetryMetadata() {
            ...
            assertThat(counter("recallix.outbox.failures", "category", "infrastructure"))
                    .isEqualTo(1d);
            assertThat(counter("recallix.outbox.retired")).isZero();
        }
    ...
    class Poison {
        ...
        void retired() {
            ...
            assertThat(counter("recallix.outbox.retired")).isEqualTo(1d);
            assertThat(counter("recallix.outbox.failures", "category", "event_permanent"))
                    .isEqualTo(1d);
        }
        ...
        void doesNotStopTheBatch() {
            ...
            assertThat(counter("recallix.outbox.published")).isEqualTo(2d);
        }
