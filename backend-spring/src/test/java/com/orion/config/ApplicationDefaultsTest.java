 ...
 * {@code DeploymentCheck} all declare {@code @Value("${orion.auth-mode:clerk}")},
 * and {@link com.orion.security.AuthModeDefaultTest} pins that they fail
 ...
 * {@code auth-mode: ${ORION_AUTH_MODE:dev}} — which made it present, in
...
class ApplicationDefaultsTest {
    ...
    void authModeFailsClosed() {
        ...
        assertThat(environment.getProperty("orion.auth-mode")).isEqualTo("clerk");
    }
    ...
    void theInternalTokenIsUnset() {
        ...
        assertThat(environment.getProperty("orion.internal-token")).isEmpty();
    }
    ...
    void clerkHasNoDefaults() {
        ...
        assertThat(environment.getProperty("orion.clerk.issuer")).isEmpty();
        assertThat(environment.getProperty("orion.clerk.jwks-url")).isEmpty();
    }
