...
class OutboxPublisherTest {
    ...
    void marksAfterTheAcknowledgement() {
        ...
        assertThat(counter("orion.outbox.published")).isEqualTo(1d);
    }
    ...
    class Infrastructure {
        ...
        void recordsRetryMetadata() {
            ...
            assertThat(counter("orion.outbox.failures", "category", "infrastructure"))
                    .isEqualTo(1d);
            assertThat(counter("orion.outbox.retired")).isZero();
        }
    ...
    class Poison {
        ...
        void retired() {
            ...
            assertThat(counter("orion.outbox.retired")).isEqualTo(1d);
            assertThat(counter("orion.outbox.failures", "category", "event_permanent"))
                    .isEqualTo(1d);
        }
        ...
        void doesNotStopTheBatch() {
            ...
            assertThat(counter("orion.outbox.published")).isEqualTo(2d);
        }
