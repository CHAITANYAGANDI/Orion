-- Recallix AI — PostgreSQL schema (source of truth).
-- Spring Boot manages this via Flyway migration V1__init.sql (identical content).
-- IDs are text (prefixed: usr_, mtg_, ai_, dec_, rsk_, sub_, aud_) generated by the app.
