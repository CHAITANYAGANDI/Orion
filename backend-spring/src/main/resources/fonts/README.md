...
empty boxes, so the glyphs for every script Recallix works in have to be here.
...
See `com.recallix.export.PdfFonts` for how they are selected, and for the one
