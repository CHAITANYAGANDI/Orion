...
public class DocxRenderer implements DocumentRenderer {
    ...
    private String document(ExportDocument doc) {
        ...
        body.append(paragraph(doc, "Notice", run(doc, "Exported from Recallix AI", null)));
    ...
    private String coreProperties(ExportDocument doc) {
        return """
                ...
                <dc:title>%s</dc:title>\
                <dc:creator>Recallix AI</dc:creator>\
                <cp:lastModifiedBy>Recallix AI</cp:lastModifiedBy>\
