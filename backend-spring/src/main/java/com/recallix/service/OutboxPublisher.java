...
public class OutboxPublisher {
    ...
    OutboxPublisher(OutboxEventRepository repo,
        ...
        this.published = Counter.builder("recallix.outbox.published")
                ...
                .register(metrics);
        this.retired = Counter.builder("recallix.outbox.retired")
                .description("Outbox events abandoned as unpublishable. Alert on this.")
                .register(metrics);
        this.failedTransient = Counter.builder("recallix.outbox.failures")
                .description("Failed publication attempts")
                .tag("category", "infrastructure")
                .register(metrics);
        this.failedPermanent = Counter.builder("recallix.outbox.failures")
                .description("Failed publication attempts")
