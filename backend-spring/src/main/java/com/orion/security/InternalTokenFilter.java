 ...
 * That made a deployment which never set {@code ORION_INTERNAL_TOKEN} look
...
public class InternalTokenFilter extends OncePerRequestFilter {
    ...
    public InternalTokenFilter(@Value("${orion.internal-token:}") String internalToken) {
        this.internalToken = internalToken == null ? "" : internalToken.trim();
        if (this.internalToken.isEmpty()) {
            log.warn("ORION_INTERNAL_TOKEN is not set: every /internal/** callback "
