...
import com.orion.entity.MailMessage;
...
public class MailDispatcher {
    ...
    public MailDispatcher(MailOutboxRepository outbox,
                          Mailer mailer,
                          @Value("${orion.mail.batch:25}") int batchSize,
                          @Value("${orion.mail.max-attempts:12}") int maxAttempts,
                          @Value("${orion.mail.first-backoff-seconds:30}") long firstBackoff,
                          @Value("${orion.mail.max-backoff-seconds:3600}") long maxBackoff) {
        this.outbox = outbox;
        this.mailer = mailer;
