...
/**
 * The things Orion will tell you about.
 *
 ...
 * Orion has one account per workspace: no teams, no members, no invitations.
...
public enum NotificationKind {
     ...
     *
     * <p>Requires a display name — without one, Orion has no way to know
