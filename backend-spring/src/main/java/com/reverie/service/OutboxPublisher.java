...
public class OutboxPublisher {
    ...
    OutboxPublisher(OutboxEventRepository repo,
        ...
        this.events = events;
        this.clock = clock;
        this.published = Counter.builder("reverie.outbox.published")
                .description("Outbox events acknowledged by Kafka")
                .register(metrics);
        this.retired = Counter.builder("reverie.outbox.retired")
                .description("Outbox events abandoned as unpublishable. Alert on this.")
                .register(metrics);
        this.failedTransient = Counter.builder("reverie.outbox.failures")
                .description("Failed publication attempts")
                .tag("category", "infrastructure")
                .register(metrics);
        this.failedPermanent = Counter.builder("reverie.outbox.failures")
                .description("Failed publication attempts")
