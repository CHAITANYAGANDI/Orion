...
public record PreferencesUpdateRequest(
         ...
         * The account address.
         *
         * <p>Accepted only where Reverie owns it. Under an identity provider
        ...
        @Max(value = 3650, message = "Ten years is the most Reverie will look back")
        Integer chatHistoryDays,
        Boolean chatReadsEverything,

        /**
         * The five messages Reverie will send by mail. Null leaves one alone.
         *
