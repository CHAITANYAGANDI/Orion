 ...
 * That made a deployment which never set {@code REVERIE_INTERNAL_TOKEN} look
...
public class InternalTokenFilter extends OncePerRequestFilter {
    ...
    public InternalTokenFilter(@Value("${reverie.internal-token:}") String internalToken) {
        this.internalToken = internalToken == null ? "" : internalToken.trim();
        if (this.internalToken.isEmpty()) {
            log.warn("REVERIE_INTERNAL_TOKEN is not set: every /internal/** callback "
