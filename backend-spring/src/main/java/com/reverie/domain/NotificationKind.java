...
/**
 * The things Reverie will tell you about.
 *
 ...
 * Reverie has one account per workspace: no teams, no members, no invitations.
...
public enum NotificationKind {
     ...
     *
     * <p>Requires a display name — without one, Reverie has no way to know
