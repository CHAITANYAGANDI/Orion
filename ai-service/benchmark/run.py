"""Run one audio file through Reverie transcription and score the result.
...
original complaint about Reverie's transcription quality and it measures
...
The comparison this runs is the fair one — the *same file*, through Reverie's
