...
acronyms, the client. Reverie already knows some of them at the moment it
...
class MeetingContext:
    """What Reverie knows about a recording before it has heard it.
...
def meaningful_title(title: str | None) -> str | None:
    ...
    "Recording — 19/08/2026, 21:15" is the name Reverie gives a recording
