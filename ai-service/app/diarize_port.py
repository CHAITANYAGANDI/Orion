...
is no correct provider label anywhere in the response for Recallix to recover.
...
class Timeline:
    ...
    below wants an *exclusive* timeline, because Recallix stores one speaker per
