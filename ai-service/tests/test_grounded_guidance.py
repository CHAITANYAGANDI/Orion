...
def test_no_answer_may_claim_a_capability_reverie_does_not_have():
...
def test_background_describes_the_category_and_never_this_instance():
    ...
    not supported by forty-seven seconds of promotional speech and Reverie has
...
def test_a_previous_answer_is_never_handed_back_as_evidence():
    ...
    the follow-up would be grounded in Reverie's own advice.
    """
