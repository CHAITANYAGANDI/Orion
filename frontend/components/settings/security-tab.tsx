 ...
 *
 * The tab somebody opens when they stop and think about what a meeting
...
import type { LiveLink, RetentionPolicy, SignInFacts } from "@/lib/types";
...
export function SecurityTab() {
  ...
  const { held, retention, storage, signIn, liveLinks } = overview.data;

  return (
    <div className="space-y-6">
      <p className="text-sm text-muted-foreground">
        How you get in, what Recallix holds, who can see it, how long it stays,
        and how to take it all with you or make it stop.
      </p>
